...
<body class="hold-transition sidebar-collapse layout-top-nav">
                              ...
                              action file = submitfile -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="textarea" name="jawabanessay1" id="jawabanessay1"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-11 ml-3">
                                            <input type="textarea" name="jawabanessay2" id="jawabanessay2"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-11 ml-3">
                                            <input type="textarea" name="jawabanessay3" id="jawabanessay3"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-11 ml-3">
                                            <input type="textarea" name="jawabanessay4" id="jawabanessay4"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-11 ml-3">
                                            <input type="textarea" name="jawabanessay5" id="jawabanessay5"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(function() {
        ...
        // Buatin fungsi summernote sesuai jumlah jawaban
        $('#jawabanessay1').summernote()
        $('#jawabanessay2').summernote()
        $('#jawabanessay3').summernote()
        $('#jawabanessay4').summernote()
        $('#jawabanessay5').summernote()
        $('#jawabanessay6').summernote()
        $('#jawabanessay7').summernote()
        $('#jawabanessay8').summernote()
