          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Teknik Inforamtika</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><span class="live-clock"><?=date('H:i:s')?></span></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
                            ...
                            <table id="listujian" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>45 Menit</td>
                                        <td><button data-toggle="modal" data-target="#cekhasil"
...
<!-- Modal Add Data -->
<div class="modal fade" id="cekhasil">
