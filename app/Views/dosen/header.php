...
<body class="hold-transition layout-navbar-fixed">
    ...
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-dark navbar-light bg-cyan">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="dosen_dashboard" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="dosen_datamahasiswa" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>DATA MAHASISWA</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="dosen_banksoal" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>BANK SOAL</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="manageujian" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>MANAGE UJIAN</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="hasilujian" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>HASIL UJIAN</p>
                            </a>
                        </li>
