            ...
            <form action="inputpilgan" method="post">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <!-- <input type="text" class="form-control col-2" id="exampleInputSeri" name="serisoalessay"
                            placeholder="Seri Soal"> -->
                        <select name="serisoalessay" class="form-control col-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="textarea" name="essaysoal" id="summernote"></input>
                    </div>
                    <div class="form-group">
                        <label>Input Jawaban Essay</label>
                        <textarea class="form-control" rows="3" placeholder="Jawaban" name="essayjawaban"></textarea>
                    </div>
                </div>
                <!-- /.card-body -->
