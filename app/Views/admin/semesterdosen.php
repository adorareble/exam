                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Jubaidah</td>
                                        <td>
                                            <span class="badge rounded-pill bg-success">III (TIGA)</span>
                                            <span class="badge rounded-pill bg-success">IV (EMPAT)</span>
                                            <span class="badge rounded-pill bg-success">VII (TUJUH)</span>
                                        </td>
