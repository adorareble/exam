            ...
            <form action="inputpilgan" method="post">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <!-- <input type="text" class="form-control col-2" id="exampleInputSeri" name="serisoalfile"
                            placeholder="Seri Soal"> -->
                        <select name="serisoalfile" class="form-control col-5">
                                ...
                                <div class="p-0">
                                    <table class="table table-hover table-sm">
                                        <tbody>
                                            ...
                                            <tr class="expandable-body">
                                                <td colspan="5">
                                                    <iframe src="asset\CV_Indra Gifari Afriansyah_NEW.pdf" width="1080" height="1920"></iframe>
                                                </td>
                                            </tr>
                                            <tr data-widget="expandable-table" aria-expanded="false">
